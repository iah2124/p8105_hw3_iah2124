...
This plot shows the median duration for each day of the week for each
month (jan and july) for each year (2020 and 2024). In Jan and July
2020, Saturdays and Sundays had many more riders than the other 5 days.
This is similar in july 2024, where Saturday is the most ridden day, and
Sunday after that. The other days are much lower, with a slight peak on
Thursday. In Jan 2024, there is more of a gradual increase each day
starting with Sunday, and increasing each day (besides a dip on
Tuesdays), all the way until Saturday with a peak. The median durations
are higher in the July months than the Jan months for both years.
...
This plot shows the distribution of rides by month, membership status,
and bike type. Most bike rides are between about 1 - 25 minutes long.
Very few rides are between 35 and 100 minutes. The shape of all of the
plots is thicker at the bottom and gets much thinner upwards in an
almost triangle shape. Casual riders typically ride a bit longer, with
more data points in the 25-60 minute range. There seems to be less
riders who use the electric bikes, and usually ride about the same
amount as the classic bike. Casual riders do however ride a bit longer
on classic compared to electric bikes.
