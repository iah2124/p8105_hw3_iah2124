...
![](p8105_hw3_iah2124_files/figure-gfm/unnamed-chunk-27-1.png)<!-- -->
...
when compared to both years in Jan. 
...
![](p8105_hw3_iah2124_files/figure-gfm/unnamed-chunk-35-1.png)<!-- -->
...
ggplot(timesummaryciti_df, aes(x = weekdays, y = median_duration, group = year, color = year)) +
  ...
  scale_color_manual(values = c("2020" = "green", "2024" = "red")) +  
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) 
```
